...
-- primeira operação feita sobre a tabela inicial que elimina todas as matérias já cursadas

drop view todas_disciplinas_que_faltam_cursar_do_curso;

CREATE VIEW todas_disciplinas_que_faltam_cursar_do_curso AS
 SELECT 
		todas_disciplinas_do_curso.iddisciplina,
        todas_disciplinas_do_curso.Disciplina,
        todas_disciplinas_do_curso.idmatricula,
        todas_disciplinas_do_curso.Matricula
